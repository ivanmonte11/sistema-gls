  ...
  <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow cursor-pointer">
    ...
    <p className="text-gray-600">Gestiona el inventario de pollos disponibles.</p>
        ...
        <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow">
          ...
          <h2 className="text-xl font-semibold text-gray-800 mb-2">Historial de Ventas</h2>
          <p className="text-gray-600">Revisa el registro completo de ventas realizadas.</p>
        </div>
