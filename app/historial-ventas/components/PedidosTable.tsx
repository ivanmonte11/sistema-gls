...
import { formatMetodoPago, formatTipoEnvio, formatNumeroPedido, formatPrecio, formatCantidadPollo, formatHora } from '../utils/formatters';
...
export const PedidosTable = ({
  ...
  const filteredPedidos = useMemo(() => {
    const currentPedidos = activeTab === 'todos' ? pedidos : pedidosEntregados;
          ...
          <tbody>
            {filteredPedidos.length > 0 ? (
              filteredPedidos.map((pedido) => (
                ...
                <td className="text-lg font-bold text-gray-800 tracking-wide">
